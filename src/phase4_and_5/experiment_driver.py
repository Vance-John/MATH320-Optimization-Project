...
def load_data():
    ...
    try:
        X_train = np.load(os.path.join(data_dir, 'X_train_01.npy'))
        Y_train = np.load(os.path.join(data_dir, 'Y_train_01.npy'))
        X_test = np.load(os.path.join(data_dir, 'X_test_01.npy'))
        Y_test = np.load(os.path.join(data_dir, 'Y_test_01.npy'))
