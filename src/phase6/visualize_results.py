...
results_path = os.path.join(current_dir, '../phase4_and_5/experiment_results.json')
...
def plot_results():
    ...
    plt.tight_layout()
    plt.savefig('figure1_runtime_log.png')
    print("Saved figure1_runtime_log.png")
    ...
    plt.legend(fontsize=12)
    plt.tight_layout()
    plt.savefig('figure2_accuracy.png')
    ...
    if '20' in data and 'BFGS' in data['20']:
        ...
        plt.legend(fontsize=12)
        plt.tight_layout()
        plt.savefig('figure3_convergence_h20.png')
        print("Saved figure3_convergence_h20.png")
